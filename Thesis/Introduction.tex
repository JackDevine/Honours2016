...
\begin{figure}
\begin{subfigure}{0.49\textwidth}
		\includegraphics[width=\columnwidth]{TimeDependentInit}
		\caption{\label{fig:Init}}
\end{subfigure}
\begin{subfigure}{0.49\textwidth}
		\includegraphics[width=\columnwidth]{TimeDependentLater}
		\caption{\label{fig:NoPot}}
\end{subfigure}
\begin{subfigure}{0.49\textwidth}
		\includegraphics[width=\columnwidth]{TimeDependentFinal}
             \caption{\label{fig:Final}}
\end{subfigure}
\caption{Schematic of particles diffusing in a time dependent potential, the blue line represents the potential and the black line represents the particle probability density. In \subref{fig:Init} the particles are stuck in the first potential well, a certain time later the electric field is turned off and the particles diffuse freely as shown in part \subref{fig:NoPot}. When the potential is turned back on again \subref{fig:Final}, a large number of the particles will get stuck in the well to the left of the first one thus creating a net current to the left.}
